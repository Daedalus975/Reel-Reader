          ...
          {spotifyPlaylists.length > 0 && (
            <div className="bg-surface rounded-none p-1">
              ...
              {showSpotifyPlaylists && (
                <div className="px-4 pb-4 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
                  {spotifyPlaylists.map((playlist) => (
                    <div
                      key={playlist.id}
                      className="bg-dark p-3 rounded-none hover:bg-dark/80 cursor-pointer group relative"
                    ...
                    >
                      {playlist.imageUrl ? (
                        <img
                          ...
                          alt={playlist.name}
                          className="w-full aspect-square object-cover rounded-none mb-2"
                        />
                      ) : (
